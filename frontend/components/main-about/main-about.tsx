            ...
            <div className="min-h-[1216px] bg-[#1F1F1F] mt-20 max-md:mt-[48px] bg-repeat bg-pill bg-[length:250px] max-md:bg-[length:130px]">
                <div className="max-w-[1312px] max-md:max-w-[382px] mx-auto px-4 flex flex-col items-center">
                    ...
                    <div className="w-full bg-[rgba(0,_0,_0,_0.35)] max-md:flex max-md:flex-col max-md:gap-4 max-md:bg-transparent max-md:p-0 rounded-[24px] px-[50px] pt-[28px] pb-[40px] mt-[22px]">
                        <section className="text-[1.625rem]/[2.25rem] max-md:text-[1rem]/[1.125rem] max-md:p-4 text-justify font-normal text-white max-md:bg-[#343434] max-md:rounded-[18px] max-md:w-full">
                            <h3 className="font-bold">Ми — SuppHub.</h3>
                            <p className="mb-8 max-md:mb-4">
                                Ми не просто інтернет-магазин вітамінів, ми твій компаньйон у світі дедлайнів, інтенсивного навчання та великих амбіцій.
                            </p>
                            <ol className="list-decimal list-inside mb-8 max-md:mb-4 marker:font-bold">
