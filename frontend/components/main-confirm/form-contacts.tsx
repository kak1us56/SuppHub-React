...
export function FormContacts() {
    ...
    return (
        <div className="flex flex-col max-md:pt-4">
            ...
            <div className="flex flex-col gap-[18px] pt-8 max-md:pt-1 max-md:pl-[18px] max-md:gap-[10px]">
                <div className="flex justify-between max-md:flex-col max-md:gap-[10px]">
                    <div className="flex flex-col">
                        <label htmlFor="inputName"
                            className="text-[1.25rem]/[20px] pl-[9px] tracking-[1.4px] font-medium text-white pb-[10px] max-md:p-0 max-md:text-[14px] max-md:tracking-[0.98px]">
                            Ім’я*
                        </label>
                        <input type="text"
                            ref={states.inputNameRef}
                            id="inputName" 
                            className="w-[12.5rem] h-[2.75rem] max-md:w-[14rem] max-md:h-[2rem] rounded-[5px] bg-[#494949] pl-[11px] text-white
                                text-[1.25rem]/[20px] max-md:text-[16px]/[14px] tracking-[1.4px] max-md:tracking-[1.15px] border-0 outline-none font-medium" />
                    ...
                    <div className="flex flex-col w-[17.1875rem]">
                        <label htmlFor="inputVorname"
                            className="text-[1.25rem]/[20px] pl-[9px] pb-[10px] tracking-[1.4px] font-medium text-white max-md:p-0 max-md:text-[14px] max-md:tracking-[0.98px]">
                            Прізвище*
                        </label>
                        <input type="text"
                            ref={states.inputVornameRef}
                            id="inputVorname" 
                            className="w-[17.1875rem] h-[2.75rem] max-md:w-[14rem] max-md:h-[2rem] rounded-[5px] bg-[#494949] pl-[11px] text-white
                                text-[1.25rem]/[20px] tracking-[1.4px] border-0 outline-none font-medium max-md:tracking-[1.15px] max-md:text-[16px]/[14px]" />
                ...
                <div className="flex flex-col">
                    ...
                    <input type="tel"
                        ...
                        onFocus={() => valueTel()}
                        className="w-[31.125rem] h-[2.75rem] max-md:w-[15.5rem] max-md:h-[2rem] rounded-[5px] bg-[#494949] pl-[11px] text-white
                            text-[1.25rem]/[20px] tracking-[1.4px] border-0 outline-none font-medium max-md:tracking-[1.15px] max-md:text-[16px]/[14px]" />
